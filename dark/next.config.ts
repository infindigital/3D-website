...
const nextConfig: NextConfig = {
  ...
  // This copy sits inside the bright site's repository, so there is a second
  // lockfile in a parent directory and Turbopack would otherwise have to
  // guess which project it is building. Pinning the root to this folder is
  // what makes a build here mean this folder and nothing above it.
